...
# python examples/robot_retarget.py --data_path demo_data/tt4d --task-type robot_only --task-name smplh_ttg_test_1 --data_format tt4d --save_dir /bluesclues-data/home/pingpong-nima/holosoma/src/holosoma_retargeting/demo_results/g1/robot_only/tt4d/smplh_ttg_test_1.npzdemo_results/g1/robot_only/tt4d --retargeter.debug --retargeter.visualize
