...
def load_tt4d_data(file_path: str) -> tuple[np.ndarray, np.ndarray]:
    ...
    # let's bring the feet keypoints down by 3 cm
    # "Pelvis",         # 0
    # "L_Hip",          # 1
    # "L_Knee",         # 2
    # "L_Ankle",        # 3
    ...
    # array([0.62897295, 0.55360013, 0.46500203, 0.07233723, 0.02263105,
    #     0.54237461, 0.42739087, 0.06928805, 0.0024482 , 0.74491322,
    #     0.80285984, 0.82512015, 0.97724962, 0.98638839, 0.92150545,
    #     0.97575194, 0.94167793, 0.71616697, 0.71616697, 0.71616697,
    #     0.71616697, 0.71616697, 0.71616697, 0.71616697, 0.71616697,
    #     0.71616697, 0.71616697, 0.71616697, 0.71616697, 0.71616697,
    #     0.71616697, 0.71616697, 0.71616697, 0.89426881, 0.9192214 ,
    #     0.76894081, 0.86148208, 0.86148208, 0.86148208, 0.86148208,
    #     0.86148208, 0.86148208, 0.86148208, 0.86148208, 0.86148208,
    #     0.86148208, 0.86148208, 0.86148208, 0.86148208, 0.86148208,
    #     0.86148208, 0.86148208])

    # import pdb; pdb.set_trace()
    human_joints[:, [3, 4, 7, 8], 2] -= 0.1
    human_joints[:, [3, 4, 7, 8], 2] = np.where(human_joints[:, [3, 4, 7, 8], 2] < 0, 0, human_joints[:, [3, 4, 7, 8], 2])
